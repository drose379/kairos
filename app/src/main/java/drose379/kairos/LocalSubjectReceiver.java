...
public class LocalSubjectReceiver {
    ...
    public LocalSubjectReceiver(Fragment frag, int ownerID) {
        ...
        httpCall.enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                try {
                    ...
                    final ArrayList<String> allCategories = toArrayList(servResponse.getJSONArray("allCategories"));
                    ArrayList<Category> subCategories = stripDuplicates(servResponse.getJSONArray("categories"));
                    ArrayList<Subject> subjects = sortSubjects(servResponse.getJSONArray("fullSubInfo"));
                    final ArrayList<Category> fullCategories = createFullCategories(subCategories,subjects);

                    handler.post(new Runnable() {
                        @Override
                        public void run() {
                            parentFrag.getLocalData(allCategories,fullCategories);
                        }
                    });
    ...
    public ArrayList<String> toArrayList(JSONArray categories) throws JSONException {
